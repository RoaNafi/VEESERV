...
function convertTo24HourFormat(time12h) {
  ...
  return (
    <TouchableOpacity onPress={onShopPress} activeOpacity={0.7}>
      <View style={styles.card}>
        <Image
          source={{
            uri: image || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTndajZaCUGn5HCQrAQIS6QBUNU9OZjAgXzDw&s" || profile_picture,
          }}
          style={styles.image}
        />
  ...
  {String(street || "") + ", " + String(city || "Unknown City")}
            ...
            <Ionicons  workshop_name="chevron-forward" size={16} color={Colors.darkGray} style={styles.arrowIcon} />
          </View>

          <View style={styles.ratingDistanceContainer}>
            <View style={styles.ratingContainer}>
              <Ionicons  workshop_name="star" size={12} color="#FFD700" />
<Text style={styles.ratingText}>
  {String(rate.toFixed(1))}
</Text>
            </View>
            <View style={styles.distanceContainer}>
              <Ionicons  workshop_name="location-outline" size={12} color={Colors.blue} />
